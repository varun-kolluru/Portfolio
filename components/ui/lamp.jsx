  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        Connect With Me At
        <div className="flex py-10 text-xl justify-center items-center gap-5">
      <div>
        <a
          href="https://www.linkedin.com/in/varun-kolluru-683534236"
          target="_blank"
          rel="noopener noreferrer"
          className="flex text-xs md:text-2xl items-center gap-2 text-blue-600 hover:text-sm md:hover:text-3xl transition-all duration-300"
        >
          <FaLinkedin size={24} />
          LinkedIn
        </a>
      ...
      <div>
        <a
          href="https://github.com/varun-kolluru"
          target="_blank"
          rel="noopener noreferrer"
          className="flex text-xs md:text-2xl items-center gap-2 text-gray-400 hover:text-sm md:hover:text-3xl transition-all duration-300"
        >
          <FaGithub size={24} />
          GitHub
        </a>
      ...
      <div>
        <p
          className="flex text-xs md:text-2xl items-center gap-2 text-green-600 hover:text-sm md:hover:text-3xl transition-all duration-300"
        >
          <FaPhoneAlt size={24} />
          +91-9494160404
        </p>
      ...
      <div>
      <p
          className="flex text-xs md:text-2xl items-center gap-2 text-red-400 hover:text-sm md:hover:text-3xl transition-all duration-300"
        >
          <FaEnvelope size={24} />
          kolluruvarun999@gmail.com
        </p>
      </div>
    </div>
      </motion.h1>
    ...
    <div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-purple-300 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-purple-300 "></motion.div>
